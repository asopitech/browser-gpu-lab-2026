...
| 2026-09-25 | Wasmer 7.4.2 / WasmEdge 0.17.1 / wazero 1.11.0 | macOS arm64 | CPU | `labs/go-wasm` / `labs/moonbit-browser` | Go・TinyGo・MoonBitのWASIモジュールを各ランタイムで実行し、すべて `42` を確認 |
